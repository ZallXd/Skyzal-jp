...
const client = makeWASocket({ logger: pino ({ level: 'silent' }), printQRInTerminal: true, auth: state, browser: ["SC Simple By SanZz", "Dekstop", "3.0"]})
console.log(color('[ SC BY Hengkel SanZz ]\n', 'red'),color('\nInfo Script :\n➸ Baileys : Multi Device\n➸ Nama Script : JpmXPush\n➸ Creator : SanZz JB\n\nFollow My Social Media Account All Yes :\n➸ My Youtube : AlwaysSanZz1`\n➸ My Instagram : @alwasysanz\n\nDonase Me For Support :\n➸ DONASI : https://saweria.co/sanzoffc\n\nThanks\n', 'red'))
